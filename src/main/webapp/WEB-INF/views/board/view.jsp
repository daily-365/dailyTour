   ...
   <br><br>
    ...
    <section class="container">
       ...
       <c:forEach var="list" items="${list}">
        ...
        <p><span class="pull-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/board/modify?boardNo=${list.boardNo}">제목 : ${list.boardTitle}</a></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>등록일 : <fmt:formatDate value="${list.boardDate}" pattern="yyyy-MM-dd"/></span><span class="pull-right">조회수 : ${list.boardVisit}&nbsp;&nbsp;&nbsp;&nbsp;</span> </p>
        
            
        <p  style="border-top: 2px solid red;"> <br>&nbsp;${list.boardContent}</p>
