  ...
  <div class="modal fade" id="myModal" role="dialog"> <!-- 사용자 지정 부분① : id명 -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
            ...
            <label>ID</label><br>
             <input type="text" id="userid" name="userId" placeholder="아이디를 입력해주세요" required="required"><br><br>
               <label>PW</label><br>
             <input type="password" id="userPw" name="userPw" placeholder="비밀번호를 입력해주세요" required="required"><br><br>
